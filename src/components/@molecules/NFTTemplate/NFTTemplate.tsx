...
const getFontSize = (str: string) => {
  ...
  ctx.font = '700 20px "Space Grotesk", "Noto Color Emoji", "Apple Color Emoji", sans-serif'
...
const Text = styled.text(
  () => css`
    font-family: 'Space Grotesk', 'Noto Color Emoji', 'Apple Color Emoji', sans-serif;
    font-style: normal;
...
const NFTTemplate = ({ name, backgroundImage, isNormalised }: Props) => {
  ...
  return (
    <svg viewBox="0 0 270 270" display="block" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <image href="/favicon.svg" x="32" y="32" width="42" height="44" filter="url(#dropShadow)" />
      {!isNormalised && (
        <>
